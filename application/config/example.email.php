...
return array(
	...
	// If you want email notification if one of the primary users is deleted or has a password changed
	// set these accordingly.  If not, you can leave as is.
	'default_from' => 'from@tempuri.com',
	'default_to' => 'to@tempuri.com',
);
